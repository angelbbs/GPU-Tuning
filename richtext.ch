...
#define CM_TO_TWIP int(1440/2.54)
...
#define HIDDEN_ON     "\v"
#define BACK_ON       "\clshdng2000"
#define BACK_OFF      "\clshdng0"
...
#xcommand DEFINE NEWTABLE <oRTF> ;
                ...
                [ HEADERROWS <nHeadRows> ;
                        ...
                        [ HEADERFONTCOLOR <nTblHdFColor> ] ;
                        [ HEADERJOIN <aColJoin,...>] ;
                        [ HEADERFONTSIZES <aHeadTitFontSize,...> ] ;
                        [ HEADERTEXTORIENTATION <aHeadTitTextOrientation,...> ] ;
                ] ;
        => ;
                <oRTF>:DefNewTable( <"cHorzAlign">, <nFontNumber>, <nFontSize>, ;
                                ...
                                <cHeadAppear>, <"cHeadHAlign">,<nTblHdColor>,<nTblHdFColor>,;
                                [\{<aColJoin>\}], \{<aHeadTitFontSize>\}, [\{<aHeadTitTextOrientation>\}] )

...
//nM îòêóäà â ñòðîêå
 ...
 cName:=devices->NAME
 cUUID:=devices->UUID
//?aDev[nId-20000,1], aDev[nId-20000,2], aDev[nId-20000,3] //îòêóäà
//?cDevID, cName, cUUID //êóäà
select 33
dbgotop()
do while eof()=.f.
...
//?"Îòêóäà:", alltrim(aDev[nClickRow,3]), nM, overclock33->DEVID, overclock33->NAME, overclock33->MINER, overclock33->ALGO
...
//?"Êóäà:", alltrim(overclock->DEVID), alltrim(overclock->NAME), alltrim(overclock->MINER), alltrim(overclock->ALGO)
       dbrlock()
